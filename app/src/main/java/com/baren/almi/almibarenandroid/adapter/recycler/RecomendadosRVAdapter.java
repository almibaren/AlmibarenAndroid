...
public class RecomendadosRVAdapter extends RecyclerView.Adapter<RecomendadosRVAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecomendadosRVAdapter(Context context, List<Productos> recom) {
